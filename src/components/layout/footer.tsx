      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed max-w-xs">
              Mendefinisikan gaya streetwear urban Indonesia dengan produk premium yang terjangkau.
            </p>
          </div>

          {/* Column 2 */}
          <div className="space-y-4">
            <h4 className="font-bold text-white uppercase tracking-wider text-sm">Bantuan</h4>
            <ul className="space-y-3 text-sm">
              <li><Link href="/faq" className="hover:text-white transition-colors">FAQ</Link></li>
              <li><Link href="/cara-order" className="hover:text-white transition-colors">Cara Order</Link></li>
              <li><Link href="/pengembalian" className="hover:text-white transition-colors">Pengembalian & Penukaran</Link></li>
          ...
          {/* Column 3 */}
          <div className="space-y-4">
            <h4 className="font-bold text-white uppercase tracking-wider text-sm">Koleksi</h4>
            <ul className="space-y-3 text-sm">
              <li><Link href="/collections/kaos" className="hover:text-white transition-colors">Kaos</Link></li>
              <li><Link href="/collections/kemeja" className="hover:text-white transition-colors">Kemeja</Link></li>
              <li><Link href="/collections/celana" className="hover:text-white transition-colors">Celana</Link></li>
          ...
          {/* Column 4 */}
          <div className="space-y-4">
            <h4 className="font-bold text-white uppercase tracking-wider text-sm">Ikuti Kami</h4>
        ...
        <div className="pt-8 border-t border-gray-900 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} Toko Fashion. All rights reserved.
          </p>
